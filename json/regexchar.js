  ...
  [
    {
      ...
      "document": {
        "description": {
          ...
          "package": "regexchar",
          "source": "src/RegExChar-ExtendedRegExChar.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "ExtendedRegExChar",
          "package": "regexchar",
          "source": "src/RegExChar-ExtendedRegExChar.html#ExtendedRegExChar",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "InputData",
          "package": "regexchar",
          "source": "src/RegExChar-ExtendedRegExChar.html#InputData",
          "type": "type"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "MetaChar",
          "package": "regexchar",
          "source": "src/RegExChar-MetaChar.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "MetaChar",
          "package": "regexchar",
          "source": "src/RegExChar-MetaChar.html#MetaChar",
          "type": "newtype"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "MkMetaChar",
          "package": "regexchar",
          "signature": "MkMetaChar (Meta Char)",
          "source": "src/RegExChar-MetaChar.html#MetaChar",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/RegExChar-MetaChar.html#deconstruct",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "metaCharParser",
          "package": "regexchar",
          "signature": "Parser MetaChar",
          "source": "src/RegExChar-MetaChar.html#metaCharParser",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "RegExOptsChar",
          "package": "regexchar",
          "source": "src/RegExChar-RegExOptsChar.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "MatchSpan",
          "package": "regexchar",
          "source": "src/RegExChar-RegExOptsChar.html#MatchSpan",
          "type": "type"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "RegExOptsChar",
          "package": "regexchar",
          "source": "src/RegExChar-RegExOptsChar.html#RegExOptsChar",
          "type": "type"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/RegExChar-RegExOptsChar.html#toZeroIndexedArray",
          "type": "function"
        },
        "index": {
