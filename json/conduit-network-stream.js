[
  ...
  [
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "Header",
          "package": "conduit-network-stream",
          "source": "src/Data-Conduit-Network-Stream-Header.html#Header",
          "type": "data"
        },
        "index": {
          "hierarchy": "Data Conduit Network Stream Exceptions",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "package": "conduit-network-stream",
          "source": "src/Data-Conduit-Network-Stream-Exceptions.html#StreamException",
          "type": "data"
        },
        "index": {
          "hierarchy": "Data Conduit Network Stream Exceptions",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "package": "conduit-network-stream",
          "signature": "UnexpectedHeader Header",
          "source": "src/Data-Conduit-Network-Stream-Exceptions.html#StreamException",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eNewtype for properly encoded bytestrings.\n\u003c/p\u003e",
          "indexed": "Tue Mar 11 17:38:48 UTC 2014",
          "module": "Data.Conduit.Network.Stream",
          "name": "EncodedBS",
          "package": "conduit-network-stream",
          "source": "src/Data-Conduit-Network-Stream.html#EncodedBS",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003e\u003ccode\u003e\u003ca\u003edecode\u003c/a\u003e\u003c/code\u003e is used after receiving the individual conduit block elements.\n It is therefore not necessary to reuse other \u003ccode\u003e\u003ca\u003edecode\u003c/a\u003e\u003c/code\u003e instances (in\n contrast to \u003ccode\u003e\u003ca\u003eSendable\u003c/a\u003e\u003c/code\u003e instance definitions).\n\u003c/p\u003e",
          "indexed": "Tue Mar 11 17:38:48 UTC 2014",
          "module": "Data.Conduit.Network.Stream",
          "name": "Receivable",
          "package": "conduit-network-stream",
          "source": "src/Data-Conduit-Network-Stream.html#Receivable",
          "type": "class"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "StreamData",
          "package": "conduit-network-stream",
          "source": "src/Data-Conduit-Network-Stream-Internal.html#StreamData",
          "type": "data"
        },
        "index": {
          "hierarchy": "Data Conduit Network Stream",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eClose current stream. In order to guarantee process resource finalization,\n you \u003cem\u003emust\u003c/em\u003e use this operator after using \u003ccode\u003e\u003ca\u003ereceive\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "indexed": "Tue Mar 11 17:38:48 UTC 2014",
          "module": "Data.Conduit.Network.Stream",
          "name": "closeStream",
          "package": "conduit-network-stream",
          "signature": "StreamData m -\u003e m ()",
          "source": "src/Data-Conduit-Network-Stream.html#closeStream",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "decode",
          "package": "conduit-network-stream",
          "signature": "Conduit ByteString m a",
          "source": "src/Data-Conduit-Network-Stream.html#decode",
          "type": "method"
        },
        "index": {
          "hierarchy": "Data Conduit Network Stream",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003e\u003ccode\u003e\u003ca\u003eencode\u003c/a\u003e\u003c/code\u003e is called before sending out conduit block elements. Each\n element has to be encoded either as strict \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e or as lazy \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e\n with a known length.\n\u003c/p\u003e",
          "indexed": "Tue Mar 11 17:38:48 UTC 2014",
          "module": "Data.Conduit.Network.Stream",
          "name": "encode",
          "package": "conduit-network-stream",
          "signature": "Conduit a m EncodedBS",
          "source": "src/Data-Conduit-Network-Stream.html#encode",
          "type": "method"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eReceive the next conduit block. Might fail with the \u003ccode\u003e\u003ca\u003eClosedStream\u003c/a\u003e\u003c/code\u003e\n exception if used on a stream that has been closed by \u003ccode\u003e\u003ca\u003ecloseStream\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "indexed": "Tue Mar 11 17:38:48 UTC 2014",
          "module": "Data.Conduit.Network.Stream",
          "name": "receive",
          "package": "conduit-network-stream",
          "signature": "StreamData m -\u003e Sink a m b -\u003e m b",
          "source": "src/Data-Conduit-Network-Stream.html#receive",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eSend one conduit block.\n\u003c/p\u003e",
          "indexed": "Tue Mar 11 17:38:48 UTC 2014",
          "module": "Data.Conduit.Network.Stream",
          "name": "send",
          "package": "conduit-network-stream",
          "signature": "StreamData m -\u003e Source m a -\u003e m ()",
          "source": "src/Data-Conduit-Network-Stream.html#send",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Data-Conduit-Network-Stream.html#toStreamData",
          "type": "function"
        },
        "index": {
          "hierarchy": "Data Conduit Network Stream",
